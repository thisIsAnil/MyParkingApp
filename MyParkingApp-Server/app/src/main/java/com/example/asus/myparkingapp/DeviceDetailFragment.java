...
public class DeviceDetailFragment extends Fragment implements ConnectionInfoListener {
            ...
            public void onClick(View v) {
                ...
                new CountDownTimer(100,3000){
                    ...
                    public void onFinish() {
                        startActivityForResult(new Intent(getActivity(),Security.class),CHOOSE_FILE_RESULT_CODE);
                    }
                }.start();
            }
        });
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        BoolPref boolPref=new BoolPref(getActivity().getSharedPreferences(KEYS.PREF_NAME,Context.MODE_PRIVATE),KEYS.SUCCEED,false);
        if(!boolPref.getBooleanPref())val="-1"+"//_//"+"-1"+"//_//"+"-1";
        ...
        protected void onPostExecute(String result) {
            if (result != null) {
                ...
                if(result.equals("-1"+"//_//"+"-1"+"//_//"+"-1")){
                    ...
                    StringPref stringPref=new StringPref(context.getSharedPreferences(KEYS.PREF_NAME,Context.MODE_PRIVATE),KEYS.EMPTY_SLOTS,result);
                    stringPref.setStringPref(result);
                    Toast.makeText(context,"Updated Empty Slot List",Toast.LENGTH_SHORT).show();
                }
                //TODO Generate Route
            }
        }
