    ...
    private class PurchaseButtonClickListener implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (initCipher(mCipher, mKeyName)) {
                Toast.makeText(FingerPrintActivity.this,"Initcipher",Toast.LENGTH_SHORT).show();
                ...
                Toast.makeText(FingerPrintActivity.this," Not Initcipher",Toast.LENGTH_SHORT).show();
