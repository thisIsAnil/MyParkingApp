...
public class StorageHelper {
    ...
    public static String getVehicle(String personId, String personGroupId, Context context) {
        SharedPreferences personIdNameMap =
                context.getSharedPreferences(personGroupId + "VehicleIdNameMap", Context.MODE_PRIVATE);
        return personIdNameMap.getString(personId, "");
    }
    public static void setVehicle(String personIdToAdd, String personName, String personGroupId, Context context) {
        SharedPreferences personIdNameMap =
                context.getSharedPreferences(personGroupId + "VehicleIdNameMap", Context.MODE_PRIVATE);
        ...
        newPersonIds.add(personIdToAdd);
        SharedPreferences personIdSet =
                context.getSharedPreferences(personGroupId + "VehicleSet", Context.MODE_PRIVATE);
        SharedPreferences.Editor personIdSetEditor = personIdSet.edit();
        personIdSetEditor.putStringSet("VehicleSet", newPersonIds);
        personIdSetEditor.commit();
    }

    public static void deleteVehicle(List<String> personIdsToDelete, String personGroupId, Context context) {
        SharedPreferences personIdNameMap =
                context.getSharedPreferences(personGroupId + "VehicleIdNameMap", Context.MODE_PRIVATE);
        SharedPreferences.Editor personIdNameMapEditor = personIdNameMap.edit();
        for (String personId: personIdsToDelete) {
